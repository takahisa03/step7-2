...
<body>
    ...
    <table>
        ...
        <tbody id="content">
            ...
            <tr>
                <td>{{ $product->id }}</td>
                <td><img src="{{ asset($product->img_path) }}" width="100px" height="100px" alt="商品画像"></td>
                ...
                <td class="actions">
                    ...
                    <button class="purchase-button" data-id="{{ $product->id }}" data-price="{{ $product->price }}">購入</button>
                </td>
            </tr>
            @endforeach
        </tbody>
